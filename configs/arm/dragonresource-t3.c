 ...
 *
 * Test configuration for dragonresource T3 board
 *
...
struct {
	...
	.mem_regions = {
		...
		{
			.phys_start = 0x5f6f0000,
			.virt_start = 0x5f6f0000,
			.size = 0x1000,
			.flags = JAILHOUSE_MEM_READ,
		},
		{
			.phys_start = 0x5f6f1000,
			.virt_start = 0x5f6f1000,
			.size = 0x9000,
			.flags = JAILHOUSE_MEM_READ | JAILHOUSE_MEM_WRITE,
		},
		{
			.phys_start = 0x5f6fa000,
			.virt_start = 0x5f6fa000,
			.size = 0x2000,
			.flags = JAILHOUSE_MEM_READ | JAILHOUSE_MEM_WRITE,
		},
		{
			.phys_start = 0x5f6fc000,
			.virt_start = 0x5f6fc000,
			.size = 0x2000,
			.flags = JAILHOUSE_MEM_READ,
		},
		{
			.phys_start = 0x5f6fe000,
			.virt_start = 0x5f6fe000,
			.size = 0x2000,
			.flags = JAILHOUSE_MEM_READ,
		},
